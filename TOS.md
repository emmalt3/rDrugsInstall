...
By using the **r/Drugs Utilities Bot**, you agree to comply with these Terms of Service, our Privacy Policy, and the rules of the r/Drugs Discord community.

## 2. Medical Disclaimer
The **r/Drugs Utility Bot** is **not a medical device**. 

All information, features, and resources provided by the bot—including harm-reduction resources, **User in Crisis (UIC)** functionality, sobriety tracking, and related tools—are intended solely for educational, informational, and community-support purposes. 

Nothing provided by the bot constitutes professional medical advice, diagnosis, or treatment. Users should always seek guidance from a qualified physician, mental health professional, or other licensed healthcare provider regarding medical concerns, substance use disorders, or emergencies.
...
Users are expected to engage with all bot systems responsibly and respectfully.

## 4. Crisis Intervention Disclaimer
...
The r/Drugs moderation team and bot operators are not emergency responders. In an emergency, users should contact local emergency services, a crisis hotline, or other appropriate professional support services immediately.
